...
const verbs = [
    { word: 'run', correct: 'faster' },
    { word: 'speak', correct: 'louder' },
    { word: 'eat', correct: 'healthier' },
    { word: 'study', correct: 'harder' },
    { word: 'sleep', correct: 'longer' },
    { word: 'work', correct: 'harder' },
    { word: 'dance', correct: 'better' },
    { word: 'drive', correct: 'faster' },
    { word: 'jump', correct: 'higher' },
    { word: 'sing', correct: 'better' }
];

// Preguntas de opción múltiple (en inglés)
const textQuestions = [
    {
    ...
    {
        question: "¿Cuál es la oración correcta?", // Cambio aquí al español
        optionA: "She is more taller than her brother.",
        optionB: "She is taller than her brother.",
        correct: "She is taller than her brother."
    },
    {
        question: "¿Cuál es la oración correcta?", // Cambio aquí al español
        optionA: "They are more friendly than us.",
        optionB: "They are friendlier than us.",
        correct: "They are friendlier than us."
    },
    {
        question: "¿Cuál es la oración correcta?", // Cambio aquí al español
        optionA: "He runs more faster than me.",
        optionB: "He runs faster than me.",
        correct: "He runs faster than me."
    },
    {
        question: "¿Cuál es la oración correcta?", // Cambio aquí al español
        optionA: "She works harder than me.",
        optionB: "She works more hard than me.",
        correct: "She works harder than me."
    }
];
...
function generateQuestions() {
    ...
    if (currentQuestionIndex < verbs.length) {
        ...
        questionDiv.innerHTML = `
            <p>Escribe el comparativo de: ${currentVerb.word}</p>
